...
export default class Hero {
    ...
    setHealth(damage) {
        ...
        if (this.getHealth() <= 0) {
            ...
            if (this.race == "Dwarf" && probability <= 20) {
                console.log(this.name + " got luck and received " + damage / 2 + " damage points instead of " + damage + "pts !");
                return this.health -= damage / 2;
            }
            else {
                console.log(this.name + " receives " + damage + " of damage! any");
    ...
    die() {
        this.health = 100;
        return console.log(this.name.toUpperCase() + " DIED!");
    }
